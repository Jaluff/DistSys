...
//		echo $user->email;
    ...
    <?php } ?>
    <button class="btn btn-success" onclick="add_proveedor();"><i class="glyphicon glyphicon-plus"></i> Nuevo
        proveedor</button>
    ...
    columns: [{
        ...
        },
        {
            /* "render": function(data, type, row){
                console.log(row);
                // return data   ?  data.product.name  : '<span class="text-muded"> - </span><br>' ;
            } */
            data: "balance"
        },
        {
