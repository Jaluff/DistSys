<div class="modal" id="proveedor_modal" tabindex="-1" role="dialog" aria-labelledby="remoteModalLabel"
    aria-hidden="true">
                    ...
                    <form action="#" class="form-horizontal" id="proveedor">
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-xs-12">
                                        <input id="prov_nombre" name="prov_nombre" type="text" placeholder=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        <select id="prov_provincia" name="prov_provincia"
                                            class="form-control input-sm ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        ...
                                        <select id="prov_localidad" name="prov_localidad"
                                            class="form-control input-sm ">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        <input id="prov_direccion" name="prov_direccion" type="text"
                                            class="form-control input-sm  ">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        <input id="prov_contacto" name="prov_contacto" type="text"
                                            class="form-control input-sm  ">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        <input id="prov_cuit" name="prov_cuit" type="text" placeholder=""
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        <input id="prov_telefono" name="prov_telefono" type="text"
                                            class="form-control input-sm  ">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        <input id="prov_movil" name="prov_movil" type="text"
                                            class="form-control input-sm  ">
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        <input id="prov_correo" name="prov_correo" type="text"
                                            class="form-control input-sm  ">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 ">
                                        <input id="prov_web" name="prov_web" type="text"
                                            class="form-control input-sm  ">
                                    </div>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-12 ">
                                    <textarea id="prov_observaciones" name="prov_observaciones"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="text-center">
                                    <div class="form-group">
                                        <button class="btn btn-success" onclick="save_proveedor(); "
                                            value="Guardar_proveedor" id="Guardar_proveedor">Guardar</button>
                                        <!-- <button id="Guardarymascota" name="GuardarMascota" class="btn btn-info">Guardar y agregar mascota</button> -->
                                        <button id="Cancelar" name="Cancelar" data-dismiss="modal"
...
$(document).ready(function() {
    $('#prov_provincia').on('change', function() {
        ...
        $('#prov_provincia option:selected').each(function() {
            ...
            $.post("<?=base_url()?>proveedor/getDepartamento", {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            for (var j in data.provincias) { //console.log(data.provincias[j].id_provincia);
                if (typeof(data.provincias[j].id_provincia) != 'undefined' && data.provincias[j]
                    .id_provincia != null) {
                    if (data.datos.vendedor_id_provincia !== data.provincias[j].id_provincia) {
                        $("#prov_provincia").append("<option value='" + data.provincias[j].id_provincia +
                            "'>" + data.provincias[j].nombre + "</option>");
                    } else {
                        $("#prov_provincia").append("<option value='" + data.provincias[j].id_provincia +
                            "' selected='selected'>" + data.provincias[j].nombre + "</option>");
                    }
                }
            }
...
function getFormattedDate(d) {
    console.log(d);
    var d = new Date(d);
    d = ('0' + (d.getDate() + 1)).slice(-2) + "-" + ('0' + (d.getMonth() + 1)).slice(-2) + "-" + d
.getFullYear(); //d.getHours()).slice(-2) + ":" + ('0' + d.getMinutes()).slice(-2) + ":" + ('0' + d.getSeconds()).slice(-2);
    return d;
}
</script>