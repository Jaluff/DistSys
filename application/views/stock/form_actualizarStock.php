                            ...
                            <!-- Nav tabs -->
                            	<div class="col-md-12">
                            		<div class="col-md-6">
                                        ...
                                        <label class="col-md-5 control-label" for="sel_tpv_origen">Almacen </label>
                                            <div class="col-md-7 ">
                            	...
                            	<div class="col-md-12">                           
                                    <div class="col-md-6">
                                        <!-- Text input-->
                                        <div class="form-group ">
                                            <label class="col-md-5 control-label " for="cantidad">Cantidad a enviar</label>
                                            <div class="col-md-7 ">
                                                <input id="cantidad" name="cantidad" type="text" placeholder="" class="form-control input-sm ">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="text-center">
                                <div class="form-group">
                                    ...
                                    <button id="Cancelar" name="Cancelar" data-dismiss="modal" class="btn btn-warning">Cerrar</button>
                                </div>
                            </div>
                            </div>
                            </div>
...
//     $.ajax({
//         url: "<?php echo base_url();?>compras/ajax_enviar_producto/" + id + '/' + tpv
//         , type: "GET"
//         , dataType: "JSON"
//         , success: function (data) {
// //console.log(data);
