...
//		echo $user->email;
    if (isset($message)){ ?>
        ...
        <div class="col-md-12 panel  ">
            <!-- <div class="col-md-2 col-xs-8">        
                <a href="<?php echo  base_url('compras/nueva_compra');?>" class="btn btn-success" ><i class="glyphicon glyphicon-plus"></i> Nueva compra</a>
            </div> -->
    ...
    <table class="table table-bordered table-condensed " cellspacing="0" width="100%" id="stock">
        <thead>
            <tr>
<!--                        <th></th>-->
...
<script type="text/javascript">
    ...
    table = $('#stock').DataTable({
        ...
        .appendTo( '#compras_wrapper .col-sm-6:eq(0)' );
...
<?php 
	 ...
	 // require_once (APPPATH.'views/form_actualizarStock.php');
?>
