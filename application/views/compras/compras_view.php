    ...
    table = $('#compras').DataTable({
            ...
            "createdRow": function ( row, data, index ) {
                ...
                if( data['estado'] === 'En espera') {
                    $('td', row).eq(3).html('<h4><div class="label label-danger ">' + data['estado'] + '</div></h4>');
                }
                if( data['estado'] === 'Arribada') {
                    $('td', row).eq(3).html('<h4><div class="label label-info  ">' + data['estado'] + '</div></h4>');
                }
                if( data['estado'] === 'Aprobada') {
                    $('td', row).eq(3).html('<h4><div class="label label-success  ">' + data['estado'] + '</div></h4>');
                }
            },
            "columns": [
