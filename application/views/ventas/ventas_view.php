...
<div class="row">
    ...
    <form name="frm_tpv" id="tpv" class="form-inline">
        ...
        <div class="col-md-4 ">
            <div id="event_period">
                <input type="text" id="fecha" name="fecha" class="actual_range form-control input-sm" placeholder="Fecha desde"> -
                <input type="text" id="fecha_fin" name="fecha_fin" class="actual_range form-control input-sm" placeholder="Fecha hasta">
            </div>
        </div>
    </form>
...
$(document).ready(function() {
    ...
    var table = $('#ventas').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url() ?>ventas/ajax_list",
            "type": "POST",
            "data": function(d) {
