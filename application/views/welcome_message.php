...
$.getScript('//code.highcharts.com/highcharts.js',function(){
    ...
    Highcharts.chart('ventasPortipo', {
        ...
        series: [{
            ...
            data: [ {
                name: 'Facturas',
                y: <?php echo $ventas_totFactura->cantidad; ?>,
                sliced: false,
                selected: false
            }, {
                name: 'Pedidos',
                y: <?php echo $ventas_totPedido->cantidad; ?>
            }]
        }]
    });
    ...
    Highcharts.chart('metodo_dePago', {
        ...
        series: [{
            ...
            <?php foreach ($ventas_metodo as  $value) {?>
             {
                name: '<?php if($value->metodoPago){ echo strtoupper($value->metodoPago);}else{ echo 'NO COBRADO';}; ?>',
