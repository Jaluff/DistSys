...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
    <ul class="nav navbar-nav">
        ...
        <li class="dropdown show-on-hover"> 
            ...
            <ul class="dropdown-menu">
                <!-- <li><a href="<?=base_url()?>compras/nuevo_pedido">Nuevo pedido</a></li> -->
        ...
        <li class="dropdown show-on-hover"> 
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> PROVEEDORES <span class="caret"></span>
            </a>
            <ul class="dropdown-menu">
                <li><a href="<?=base_url()?>proveedor">Proveedores</a></li>
            </ul>
        </li>
        <li class="dropdown show-on-hover"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">DEVOLUCIONES<span class="caret"></span></a>
            <ul class="dropdown-menu">
                <li><a href="<?=base_url();?>compras">Proveedores</a></li>
                <li><a href="<?=base_url()?>stock">Clientes</a></li>
            </ul>
        </li>
