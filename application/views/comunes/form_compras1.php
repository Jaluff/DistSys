                        ...
                        <div class="col-md-12">
                            <!-- Nav tabs -->
                                ...
                                <div class="col-md-12">                           
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        <label class="col-md-5 control-label" for="stock_min">Operacion</label>
                                        <div class="col-md-7 ">
                                            <select id="operacion" name="operacion" class="form-control input-sm">
...
function editar_compra(id , tpv) {
    ...
    $.ajax({
        url: "<?php echo base_url();?>compras/ajax_edit/" + id + '/' + tpv
        , type: "GET"
        , dataType: "JSON"
