...
class Cliente extends CI_Controller {
    ...
    public function ajax_list()
    {
        ...
        foreach ($list as $cliente) {
            ...
            $mascota = $this->mascota->get_by_cliente_id($cliente->idcliente);
            foreach($mascota as  $v){
                $row['Mascota'][] = '<a  class="btn btn-xs btn-info" title="Ver o editar esta mascota" onclick="editar_mascota('.$v->id.')">'.$v->mas_nombre.'</a>';
    ...
    public function ajax_get_cliente($id)
    {
        //$data = [];
