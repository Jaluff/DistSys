...
class Cliente_model extends CI_Model {
    ...
    var $column_search = array('clientes.id_cliente','cli_nombre','telefono1','movil1','cli_direccion', 'cli_doc', 'cli_created_on','mascotas.mas_nombre'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    {
        $this->db->select('clientes.*,clientes.id_cliente as idcliente, mascotas.mas_nombre, mascotas.id,contactos.id_cliente as idc, contactos.*');
        $this->db->from($this->table);
        $this->db->join($this->table2,"$this->table.id_cliente = $this->table2.id_cliente",'left');
        $this->db->join($this->table_contacto,"$this->table.id_cliente = $this->table_contacto.id_cliente",'left');
