...
class Venta_model extends CI_Model {
    ...
    //var $table_tipo = 'tipo';
    var $column_order =  array('id_venta', 'metodoPago', 'tipo', 'fecha', 'pago_efectivo', 'pago_tarjeta', 'estado','usuario' , null); //set column field database for datatable orderable
    var $column_search = array('id_venta','fecha','tipo', 'estado'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    var $order = array('id_venta' => 'asc'); // default order
